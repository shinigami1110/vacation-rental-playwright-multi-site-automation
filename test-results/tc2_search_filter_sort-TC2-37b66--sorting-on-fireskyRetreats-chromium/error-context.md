...
- Name: tc2_search_filter_sort.spec.js >> TC2 — Search, Filtering, and Sorting Workflow [fireskyRetreats] >> Verify search, guest count, date selection, filters, and price sorting on fireskyRetreats
